...
export default function HowToPlay() {
  return (
    ...
    <section className="rounded-block">
        ...
        <img alt="Deckbuilding" src="/images/Deckbuilt.png"/>
        ...
        <img alt="Deckbuilding" src="/images/Kobytypes.png"/>
        ...
        <p>When it comes to building a deck the most important part is to experiment and find the ratios and characters you like playing. If you I also would reccomend look on our <Link to="/leaders">Leaders</Link> page for deckbuilding ideas.</p>
    </section>
    <section className="rounded-block">
        ...
        <img alt="Gameplay" src="/images/setup.png"/>
        ...
        <img alt="Gameplay" src="/images/hand.png"/>
        ...
        <img alt="Gameplay" src="/images/life.png"/> <img alt="Gameplay" src="/images/life-facedown.png"/>
        ...
        <img alt="Gameplay" src="/images/cost.png"/>
        ...
        <img alt="Gameplay" src="/images/battle.png"/>
        ...
        <img alt="Gameplay" src="/images/Counter.png"/>
